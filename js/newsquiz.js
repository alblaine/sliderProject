    ...
    $.quiz = function(quiz_data, options) {
        ...
        var quiz = {
            ...
            append_how_you_did_section: function() {
                ...
                if (correct_answers_element >= 4) {
                  cover.append(jQuery('<p class="small">Great job! You got most of them correct!</p>'));
                }
                
                cover.append(jQuery('<p class="small">Try again. You will do better next time.</p>'));
            },
